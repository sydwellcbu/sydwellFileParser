...
//        csvFlateFile = CsvFlateFile.builder().name("Momentum").surName("Health").imageFormat("image/png").imageData(base64ImageData).build();
    ...
    public void convertBase64ImageDataToPhysicalImageFile() {
        File systemFile = new File("C:/Users/Administrator/Desktop/NEW/Momentum_Health.png");
       // File fileImage = fileParser.convertCSVDataToImage(base64ImageData);
        //Files.contentOf(fileImage, "");
       // assertEquals(Files.contentOf(systemFile, StandardCharsets.UTF_8), Files.contentOf(fileImage, StandardCharsets.UTF_8));

    }

    
    public void getAccountProfileByNameAndSurnameAndImageHttpLink() {
